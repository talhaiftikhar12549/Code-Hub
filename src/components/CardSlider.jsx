...
const CardSlider = () => {
    const cards = [
        ...
        {id: 6, color: 'bg-blue-500', text: 'Card 6', image: 'https://via.placeholder.com/150'},
        ...
        {id: 12, color: 'bg-green-500', text: 'Card 12', image: 'https://via.placeholder.com/150'},
        {id: 13, color: 'bg-red-500', text: 'Card 13', image: 'https://via.placeholder.com/150'},
        {id: 14, color: 'bg-yellow-500', text: 'Card 14', image: 'https://via.placeholder.com/150'},
        {id: 15, color: 'bg-purple-500', text: 'Card 15', image: 'https://via.placeholder.com/150'},
        {id: 16, color: 'bg-blue-500', text: 'Card 16', image: 'https://via.placeholder.com/150'},
        {id: 17, color: 'bg-green-500', text: 'Card 17', image: 'https://via.placeholder.com/150'},
        {id: 18, color: 'bg-red-500', text: 'Card 18', image: 'https://via.placeholder.com/150'},
        ...
        {id: 22, color: 'bg-green-500', text: 'Card 22', image: 'https://via.placeholder.com/150'},
        {id: 23, color: 'bg-red-500', text: 'Card 23', image: 'https://via.placeholder.com/150'},
        {id: 24, color: 'bg-yellow-500', text: 'Card 24', image: 'https://via.placeholder.com/150'},
